...
import 'package:flutter_orderapp/screens/success.dart';
          ...
          Container(
            ...
            child: RaisedButton(
                ...
                child: Text("Order",
                    style: TextStyle(color: Colors.white, fontSize: 20)),
                onPressed: () {
                  if (myprovider.cartModelList.isNotEmpty) {
                    FirebaseFirestore.instance.collection("Order").doc().set({
                      "Food": myprovider.cartModelList
                          .map((c) => {
                                "Food Name": c.foodtitle,
                                "Food Price": c.price,
                                "Quantity": c.quantity,
                              })
                          .toList(),
                      "Total Price": total.toString(),
                      "User Name": "Trần Hà Phong",
                      "User Email": "haphong701@gmail.com",
                      "User Address": "126 trần cao vân",
                      "User PhoneNumer": "0905735852",
                    });
                    Navigator.of(context).pushReplacement(
                        MaterialPageRoute(builder: (ctx) => Success()));
                    myprovider.clearCartModelList();
                  } else {
                    print("No Item");
                  }
                }),
